...
class ResidualDenseBlock(torch.nn.Module):
    ...
    def __init__(self, in_features):
        ...
        self.conv1 = torch.nn.Conv2d(
            in_features, in_features, kernel_size=3, stride=1, padding=1)
        self.conv2 = torch.nn.Conv2d(
            2*in_features, in_features, kernel_size=3, stride=1, padding=1)
        self.conv3 = torch.nn.Conv2d(
            3*in_features, in_features, kernel_size=3, stride=1, padding=1)
        self.conv4 = torch.nn.Conv2d(
            4*in_features, in_features, kernel_size=3, stride=1, padding=1)
        self.conv5 = torch.nn.Conv2d(
            5*in_features, in_features, kernel_size=3, stride=1, padding=1)
