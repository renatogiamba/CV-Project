...
if __name__ == "__main__":
    ...
    cli.add_argument(
        ...
        default="./models/SRGAN_GAN-epoch_350-psnr_19.35-ssim_0.58.ckpt",
    ...
    torch.jit.save(jit_gen_model, "./models/srgan_generator_jit.pt")
    jit_disc_model = torch.jit.script(model.disc_model)
    jit_disc_model = torch.jit.freeze(jit_disc_model)
    torch.jit.save(jit_disc_model, "./models/srgan_discriminator_jit.pt")
